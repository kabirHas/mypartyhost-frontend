              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm text-right">
                    ...
                    <Link href={`/profile/${staff._id}`} className="text-pink-700 no-underline font-medium hover:underline">
                      View Profile
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-end gap-2 mt-4">
                  <button
                    ...
                    className="px-4 py-2 border-1 border-pink-600 text-pink-600 rounded-lg hover:bg-pink-600 hover:text-white text-sm flex items-center gap-1"
